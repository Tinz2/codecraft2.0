...
class _Stage4State extends State<Stage4> {
  ...
  final List<String> storyImages = [
    'assets/story/4.1.png',
    'assets/story/4.2.png',
    'assets/story/4.3.png',
    'assets/stage4.png',
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: Column(
            ...
            children: [
              Image.asset('assets/gif/player/Maruto.gif.png',
            ...
            Container(
              ...
              child: Stack(
                children: [
                  ...
                  // Apple 1
                  Positioned(
                    top: (4 * (350 / 5)) + (350 / 5 / 2) - 60,
                    left: (0 * (350 / 5)) + (350 / 5 / 2) - 50,
                    child: Image.asset(
                      'assets/gif/enamies/skale.gif',
                      width: 120,
                      height: 120,
                    ),
                  ),
                  // Apple 2
                  Positioned(
                    top: (4 * (350 / 5)) + (350 / 8) - 30,
                    left: (1 * (350 / 5)) + (350 / 8) - 30,
                    child: Image.asset(
                      'assets/gif/item/heart.gif',
                      width: 50,
                      height: 50,
                    ),
                  ),
