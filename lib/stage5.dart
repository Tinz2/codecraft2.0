...
class Stage5 extends StatefulWidget {
  @override
  _Stage5State createState() => _Stage5State();
}

class _Stage5State extends State<Stage5> {
              ...
              child: Stack(
                children: [
                  ...
                  Positioned(
                    ...
                    child: Image.asset(
                      'assets/gif/weapon/muramasa.gif',
                      width: 50,
                      height: 50,
                    ),
                  ),
                  ...
                  Positioned(
                    ...
                    left: (3 * (350 / 5)) + (350 / 5 / 2) - 50,
                    child: Image.asset(
                      'assets/gif/enamies/tesa.gif',
                      width: 120,
                      height: 120,
                    ),
                  ),
